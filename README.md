...
[**Documentation**](https://github.com/Rahulc26/Victus.git)

<br/>

[![](https://anaconda.org/conda-forge/carbonera/badges/version.svg)](https://anaconda.org/conda-forge/carbonera)
[![](https://img.shields.io/pypi/v/codecarbon?color=024758)](https://pypi.org/project/carbonera/)
[![DOI](https://zenodo.org/badge/263364731.svg)](https://zenodo.org/badge/latestdoi/263364731)


- [About CodeCarbon 💡](#about-carbonera-)
...
**Victus** started with a quite simple question: 
...
At **Victus**, we believe, along with Niels Bohr, that "Nothing exists until it is measured". So we found a way to estimate how much CO<sub>2</sub> we produce while running our code.
...
```python
conda install -c conda-forge Victus
```
...
### In your Python code 🐍
```python
from Victus import track_emissions
@track_emissions()
...
There is other ways to use **Victus** package, please refer to the documentation to learn more about it:  [**Usage**](https://mlco2.github.io/codecarbon/usage.html#)

## Visualize 📊

You can now visualize your experiment emissions on the [dashboard](https://dashboard.victus.io/).
...
> - comet integration...
>
> Please explore the [**Documentation**](https://github.com/Rahulc26/Victus.git/codecarbon) to learn about it
